...
module.exports = function (ctx) {
  return {
    ...
    build: {
      ...
      // transpile: false,
      env: ctx.dev
        ? { ...env, API: JSON.stringify('/backend') }
        : { ...env, API: JSON.stringify('https://www.safe-community.fr/backend') },
      // gzip: true,
      // analyze: true,
      // extractCSS: false,
      // useNotifier: false,
    ...
    pwa: {
      ...
      manifest: {
        name: `frontend`,
        short_name: `frontend`,
        description: `the frontend of all my futures app`,
        display: 'standalone',
